...
public class Password {
    ...
    public static void main(String[] args) {
        ...
        byte[] encodedText = myAES.AesEcbEncode(PLAIN_TEXT.getBytes(), key);

        System.out.println("AES ECB encoded with Base64: " + Base64.encodeBase64String(encodedText));
        System.out.println("AES ECB decoded: "+ myAES.AesEcbDecode(encodedText, key));



        encodedText = myAES.AesCbcEncode(PLAIN_TEXT.getBytes(), key, myAES.IVPARAMETERS);


        System.out.println("AES CBC encoded with Base64: " + Base64.encodeBase64String(encodedText));
        System.out.println("AES CBC decoded: "+ myAES.AesCbcDecode(encodedText, key,myAES.IVPARAMETERS));
    }
